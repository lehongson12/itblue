...
$_config = array(
	...
	'color'						=>'green-blue',
	'menu_styles'				=>'1',
	'body_background_color'		=>'#e6e6e6',
	'body_background_image'		=>'1',
	'responsive_menu'           =>'1',
	'body_link_color'			=>'#686868',
	'body_text_color'			=>'#686868'
);
if(Mage::getConfig()->getNode('modules/Sm_amaz')){
	$_config	=	Mage::helper('amaz/data')->get($attributes);
}
// enable Cpanel
...
global $var_yttheme;
$var_yttheme = new YtTheme('sm_amaz', $_params, $paramscookie);
?>
