...
class Sm_Scrollbar_Helper_Data extends Mage_Core_Helper_Abstract {
	...
	{
		$data = $this->defaults;
		$general 					= Mage::getStoreConfig("scrollbar_cfg/general");
		$module_setting				= Mage::getStoreConfig("scrollbar_cfg/module_setting");
		$source_setting 			= Mage::getStoreConfig("scrollbar_cfg/source_setting");
		$vertical				    = Mage::getStoreConfig("scrollbar_cfg/vertical");
		$horizontal				    = Mage::getStoreConfig("scrollbar_cfg/horizontal");
		$product_display_setting 	= Mage::getStoreConfig("scrollbar_cfg/product_display_setting");
		$advanced 					= Mage::getStoreConfig("scrollbar_cfg/advanced");
		...
		if (is_array($source_setting)) 		    $data = array_merge($data, $source_setting);
		if (is_array($vertical))                $data = array_merge($data, $vertical);
		if (is_array($horizontal)) 		        $data = array_merge($data, $horizontal);
